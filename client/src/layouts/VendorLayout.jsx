...
export default function VendorLayout() {
  ...
  const navigation = [
    { name: "My Jobs", href: "/vendor", icon: ClipboardList },
  ]
      ...
      <div className={cn(
        ...
        <div className="p-4 border-t border-border mt-auto">
          <div className="flex items-center mb-4 px-2">
            <img
              src={user?.avatar || "https://api.dicebear.com/7.x/avataaars/svg?seed=vendor"}
              alt="Avatar"
      ...
      <div className="flex flex-col flex-1 w-0 relative">
        <header className="flex items-center justify-between h-16 px-4 bg-card/80 backdrop-blur-md border-b border-border shadow-sm z-30 sticky top-0">
          <div className="flex items-center">
            ...
            <h1 className="text-xl font-semibold text-foreground hidden sm:block">Vendor Portal</h1>
          </div>
